...
public class Reflections {
	...
	public static void invokeSetter(Object obj, String propertyName, String[] value) {
		Object object = obj;
		String[] names = StringUtils.split(propertyName, ".");
		for (int i=0; i<names.length; i++){
			if(i<names.length-1){
    ...
    public static Method getAnnotationMethod(Class<?> clazz, Class<? extends Annotation> clazzAnnotation){
    	for (Method method : clazz.getMethods()){
    		Annotation annotation = method.getAnnotation(clazzAnnotation);
			if (annotation != null){
				return method;
			}
		}
