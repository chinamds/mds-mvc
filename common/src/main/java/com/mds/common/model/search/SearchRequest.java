 ...
 */
package com.mds.common.model.search;

import com.google.common.collect.Lists;
import com.google.common.collect.Maps;
import com.mds.common.model.search.exception.SearchException;
import com.mds.common.model.search.filter.*;
import com.mds.common.model.search.utils.SearchableConvertUtils;
...
public final class SearchRequest extends Searchable {
    ...
    @Override
    public Searchable addSearchFilter(final String searchProperty, final SearchOperator operator, final Object value, final Object value2) {
        SearchFilter searchFilter = SearchFilterHelper.newCondition(searchProperty, operator, value, value2);
        return addSearchFilter(searchFilter);
    }
    
    @Override
    public Searchable addSearchFilter(final String searchAlias, final String searchProperty, final SearchOperator operator, final Object value, final Object value2) {
        SearchFilter searchFilter = SearchFilterHelper.newCondition(searchAlias, searchProperty, operator, value, value2);
        return addSearchFilter(searchFilter);
    }
