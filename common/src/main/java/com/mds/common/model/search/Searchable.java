...
import com.mds.common.model.search.exception.InvalidSearchPropertyException;
import com.mds.common.model.search.exception.InvalidSearchValueException;
...
public abstract class Searchable {
     ...
     *
     * @param searchProperty query property
     * @param operator       Search Operator
     * @param value          value
     * @param value2         value2
     */
    public abstract Searchable addSearchFilter(
            final String searchProperty, final SearchOperator operator, final Object value, final Object value2) throws SearchException;
    
    /**
     * add filter condition
     *
     * @param searchAlias    query alias
     * @param searchProperty query property(not include alias)
     * @param operator       Search Operator
     * @param value          value
     * @param value2         value2
     */
    public abstract Searchable addSearchFilter(
    		final String searchAlias, final String searchProperty, final SearchOperator operator, final Object value, final Object value2) throws SearchException;
