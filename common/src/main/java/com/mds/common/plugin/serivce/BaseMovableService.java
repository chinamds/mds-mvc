 ...
 */
package com.mds.common.plugin.serivce;

import com.google.common.collect.Maps;
import com.mds.common.model.BaseEntity;
import com.mds.common.model.search.Searchable;
import com.mds.common.plugin.entity.Movable;
...
public abstract class BaseMovableService<M extends BaseEntity & Movable, ID extends Serializable> extends BaseService<M, ID> {
    ...
    public void reweight() {
        ...
        do {
            ...
            pageable = PageRequest.of((pageable.getPageNumber() + 1) * batchSize, batchSize, sort);
