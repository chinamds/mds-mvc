 ...
 */
package com.mds.aiotplayer.common.web.upload;

import com.mds.aiotplayer.common.utils.LogUtils;
import com.mds.aiotplayer.common.utils.security.Md5Utils;
import com.mds.aiotplayer.common.web.upload.exception.FileNameLengthLimitExceededException;
import com.mds.aiotplayer.common.web.upload.exception.InvalidExtensionException;
...
public class FileUploadUtils {
    ...
    private static final String encodingFilename(String filename) {
        ...
        filename = Md5Utils.hash(filename + System.nanoTime() + counter++) + "_" + filename;
        return filename;
    }
