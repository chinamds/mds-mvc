...
public class RepositoryHelperIT extends BaseUserIT {
    ...
    public void testCountWithCondition() {
        ...
        String ql = "select count(o) from User o where id >= ?1 and id <=?2";
    ...
    public void testFindAllWithCondition() {
        String ql = "select o from User o where id>=?1 and id<=?2";
    ...
    public void testFindAllWithPage() {
        ...
        List<User> list = repositoryHelper.findAll(ql, PageRequest.of(0, 2));
    ...
    public void testFindOne() {
        ...
        String ql = "select o from User o where id=?1 and baseInfo.sex=?2";
    ...
    public void testBatchUpdate() {
        ...
        String updateQL = "update User set password=?1 where id=?2";
        repositoryHelper.batchUpdate(updateQL, newPassword, user1.getId());

        clear();

        user1 = repositoryHelper.findOne("from User where id=?1", user1.getId());
