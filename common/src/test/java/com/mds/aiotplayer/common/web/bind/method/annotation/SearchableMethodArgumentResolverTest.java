 ...
 */
package com.mds.aiotplayer.common.web.bind.method.annotation;
...
import com.mds.aiotplayer.common.web.bind.annotation.SearchableDefaults;
...
public class SearchableMethodArgumentResolverTest {
    ...
    public void testSearchableWithDefaultPage() throws Exception {
        ...
        assertEquals(Sort.unsorted(), searchable.getPage().getSort());
