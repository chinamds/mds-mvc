 ...
 * <code>email.addArgument("On the Testing of MDS");</code><br>
 * <code>email.send();</code><br>
 * </p>
 * <p>
 * <code>name</code> is the name of an email template in
 * <code>mds-dir/config/emails/</code> (which also includes the subject.)
 ...
 *     Dear John,
 *
 *     Thank you for sending us your submission &quot;On the Testing of MDS&quot;.
 *
 * </pre>
 *
 * <p>
...
public class Email {
    ...
    public void send() throws MessagingException, IOException {
        ...
        // Get session
        Session session = MDSServicesFactory.getInstance().getEmailService().getSession();
     ...
     *
     * @param emailFile full name for the email template, for example "/mds/config/emails/register".
    ...
    public static void main(String[] args) {
        ...
        String subject = "MDS test email";
        String server = config.getProperty("mail.server");
        String url = config.getProperty("mds.url");
        Email e = new Email();
        e.setSubject(subject);
        e.addRecipient(to);
        e.content = "This is a test email sent from MDS: " + url;
        ...
        try {
            if (disabled) {
                ...
                System.err.println("\nPlease see the MDS documentation for assistance.\n");
                System.err.println("\n");
                System.exit(1);
                return;
            }
