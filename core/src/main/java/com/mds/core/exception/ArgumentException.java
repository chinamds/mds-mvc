...
public class ArgumentException extends BaseException {
    ...
    public ArgumentException(String paramName, Object paramValue, Throwable cause) {
    ...
    public ArgumentException(String paramName, Object paramValue) {
    ...
    //     parameter is not a null reference, the current exception is raised in a catch
    //     block that handles the inner exception.
    public ArgumentException(String paramName, Object paramValue, String module, Throwable cause) {
    ...
    public ArgumentException(String paramName, Object paramValue, String module) {
