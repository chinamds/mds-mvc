...
public interface GenericDao <T, PK extends Serializable> {
    ...
    /**
 	 ...
 	 * @return
 	 */
 	Page<T> find(Pageable page, DetachedCriteria detachedCriteria);
 	 ...
 	 * @return
 	 */
 	Page<T> find(Pageable page, DetachedCriteria detachedCriteria, ResultTransformer resultTransformer);
     ...
     * @return count of matching rows.
     */
    long countLong(Criteria criteria);
