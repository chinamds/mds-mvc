...
@WebService(serviceName = "UserGalleryProfileService", endpointInterface = "com.mds.cm.service.UserGalleryProfileManager")
public class UserGalleryProfileManagerImpl extends GenericManagerImpl<UserGalleryProfile, Long> implements UserGalleryProfileManager {
    ...
    public void saveUserGalleryProfile(UserProfile userProfile, long templateGalleryId) throws JsonProcessingException {
		...
		for (com.mds.cm.content.UserGalleryProfile userGalleryProfile : userProfile.getGalleryProfiles())
		{
			com.mds.cm.content.UserGalleryProfile ugp = userGalleryProfile;
