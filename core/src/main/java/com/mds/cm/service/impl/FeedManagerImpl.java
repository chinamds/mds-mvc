...
import com.mds.cm.content.FeedFormatterOptions;
...
import com.mds.cm.service.FeedService;
...
@Service("feedManager")
@WebService(serviceName = "FeedService", endpointInterface = "com.mds.cm.service.FeedService")
