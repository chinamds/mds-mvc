...
public class DateConverter implements Converter {
    ...
    public Object convert(final Class type, final Object value) {
        if (value == null) {
            ...
            return convertToDate(type, value, DateUtils.getDateTimePattern());
        } else if (type == Date.class) {
            return convertToDate(type, value, DateUtils.getDatePattern());
    ...
    protected Object convertToString(final Object value) {
        if (value instanceof Date) {
            DateFormat df = new SimpleDateFormat(DateUtils.getDatePattern());
