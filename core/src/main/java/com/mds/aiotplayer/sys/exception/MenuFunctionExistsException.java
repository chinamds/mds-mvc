 ...
 */
public class MenuFunctionExistsException extends Exception {
    private static final long serialVersionUID = 4050482305178810162L;

    /**
     * Constructor for MenuFunctionExistsException.
     *
     * @param message exception message
     */
    public MenuFunctionExistsException(final String message) {
        super(message);
    }
}
