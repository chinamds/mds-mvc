...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.mds.aiotplayer.sys.service.impl.PasswordTokenManager#generateRecoveryToken(com.mds.aiotplayer.model.User)
     */
    @Override
    ...
    /**
     * @see com.mds.aiotplayer.sys.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.mds.aiotplayer.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.mds.aiotplayer.sys.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
