...
import com.mds.aiotplayer.common.model.LicenseKey;
...
import com.mds.aiotplayer.core.EmailServerType;
import com.mds.aiotplayer.core.MaintenanceStatus;
import com.mds.aiotplayer.core.StringCollection;
import com.mds.aiotplayer.core.exception.ApplicationNotInitializedException;
...
public class AppSettings{
	...
	public static String getMDSHome(String providedHome) {
		return  MDSServicesFactory.getInstance().getConfigurationService().getProperty("mdsplus.home");
