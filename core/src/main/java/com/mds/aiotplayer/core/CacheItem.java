...
public enum CacheItem
{
	...
	/// <summary>
	/// A System.Collections.Concurrent.ConcurrentDictionary&lt;<see cref="string" />, <see cref="com.mds.aiotplayer.Interfaces.IMDSRoleCollection" />&gt;
	...
	sys_users,
	/// <summary>
	/// A System.Collections.Concurrent.ConcurrentDictionary&lt;<see cref="string" />, <see cref="com.mds.aiotplayer.Interfaces.IUserAccountCollection" />&gt;
	...
	/// <summary>
	/// A System.Collections.Concurrent.ConcurrentDictionary&lt;<see cref="int" />, <see cref="com.mds.aiotplayer.Interfaces.IAlbum" />&gt; 
	...
	/// <summary>
	/// A System.Collections.Concurrent.ConcurrentDictionary&lt;<see cref="int" />, <see cref="com.mds.aiotplayer.Interfaces.IGalleryObject" />&gt; 
	/// stored in cache. The key specifies the ID of the content object stored in the dictionary entry.
	/// </summary>
	cm_contentobjects,
	/// <summary>
	/// An <see cref="com.mds.aiotplayer.Interfaces.IEventLogCollection" /> stored in cache.
	/// </summary>
	AppEvents,
	/// <summary>
	/// A System.Collections.Concurrent.ConcurrentDictionary&lt;<see cref="string" />, <see cref="com.mds.aiotplayer.Interfaces.IUserProfile" />&gt; 
	/// stored in cache. The key specifies the username of the profile stored in the dictionary entry.
	/// </summary>
	cm_profiles,
	/// <summary>
	/// An <see cref="com.mds.aiotplayer.Interfaces.IUiTemplateCollection" /> stored in cache.
	/// </summary>
	cm_uitemplates,
	/// <summary>
	/// An <see cref="com.mds.aiotplayer.Interfaces.IContentTemplateCollection" /> stored in cache.
	/// </summary>
	cm_contenttemplates,
	/// <summary>
	/// A System.Collections.Concurrent.ConcurrentDictionary&lt;<see cref="int" />, <see cref="com.mds.aiotplayer.Interfaces.IMimeTypeCollection" />&gt; 
