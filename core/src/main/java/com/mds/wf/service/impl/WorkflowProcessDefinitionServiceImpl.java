...
import com.mds.util.CurrencyConverter;
import com.mds.wf.service.WorkflowProcessDefinitionService;
 ...
 *
 */
@Service("WorkflowProcessDefinitionService")
public class WorkflowProcessDefinitionServiceImpl implements WorkflowProcessDefinitionService {
	...
	private void deploySingleProcess(ResourceLoader resourceLoader, String processKey) throws IOException {
		...
		if (inputStream == null) {
			...
			logger.debug("finded workflow module: " + classpathResourceUrl + ", deploy it!");
