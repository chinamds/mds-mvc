...
import com.mds.sys.exception.RoleExistsException;
...
import com.mds.sys.service.RoleService;
 ...
 */
@Service("roleManager")
@WebService(serviceName = "roleService", endpointInterface = "com.mds.sys.service.RoleService")
