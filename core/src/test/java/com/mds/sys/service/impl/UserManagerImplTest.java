...
public class UserManagerImplTest extends BaseManagerMockTestCase {
    ...
    public void testAddAndRemoveUser() throws Exception {
        ...
        //then
        assertNull(user);
        verify(userDao).remove(new Long[] {5L});
    }
	...
	public void testEntryptPassword() {
		if (log.isDebugEnabled()) {
            log.debug("Entrypted 'admin' is: " + userManager.genPassword("admin"));
            log.debug("Entrypted 'system' is: " + userManager.genPassword("system"));
            log.debug("Entrypted 'user' is: " + userManager.genPassword("user"));
        }
	}
}
