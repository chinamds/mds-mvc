...
public class DateConverterTest {
    ...
    public void testConvertStringToDate() throws Exception {
        ...
        final String datePart = DateUtils.convertDateToString(today);
        // test empty time
    ...
    public void testConvertDateToString() throws Exception {
        ...
        assertEquals(DateUtils.convertDateToString(cal.getTime()), date);
    }
    ...
    public void testConvertTimestampToString() throws Exception {
        ...
        assertEquals(DateUtils.getDateTime(DateUtils.getDateTimePattern(), timestamp), time);
    }
