 ...
 */
public class MDSConfigurationServiceTest {
    ...
    public void init() {
        ...
        propertyFilePath = configurationService.getMDSHome(null) + File.separatorChar
            + MDSConfigurationService.DEFAULT_CONFIG_DIR + File.separatorChar + "local.properties";
    ...
    public void testVariableReplacement() {
        ...
        assertEquals("MDS", configurationService.getProperty("service.name"));
    ...
    /**
     * Test method for {@link com.mds.servicemanager.config.MDSConfigurationService#getProperties()}.
     */
    @Test
    public void testGetProperties() {
        ...
        assertEquals("MDS", props.get("service.name"));
    ...
    /**
     * Test method for
     * {@link com.mds.servicemanager.config.MDSConfigurationService#getProperty(java.lang.String)}.
     */
    @Test
    public void testGetProperty() {
        String prop = configurationService.getProperty("service.name");
        assertNotNull(prop);
        assertEquals("MDS", prop);
    ...
    /**
     * Test method for
     * {@link com.mds.servicemanager.config.MDSConfigurationService#getArrayProperty(java.lang.String)}.
     */
    @Test
    public void testGetArrayProperty() {
        ...
        MDSConfigurationService dscs = new MDSConfigurationService();
    ...
    /**
     * Test method for
     * {@link com.mds.servicemanager.config.MDSConfigurationService#getBooleanProperty(java.lang.String)}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.mds.servicemanager.config.MDSConfigurationService#getIntProperty(java.lang.String)}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.mds.servicemanager.config.MDSConfigurationService#getLongProperty(java.lang.String)}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.mds.servicemanager.config.MDSConfigurationService#getHasProperty(java.lang.String)}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.mds.servicemanager.config.MDSConfigurationService#getPropertyAsType(java.lang.String, java.lang.Class)}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.mds.servicemanager.config.MDSConfigurationService#getPropertyAsType(java.lang.String, java.lang.Object)}.
     */
    @Test
    ...
    /**
     * Test method for {@link com.mds.servicemanager.config.MDSConfigurationService#getConfiguration()}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.mds.servicemanager.config.MDSConfigurationService#loadConfig(java.lang.String, java.lang.String)}.
     */
    @Test
    public void testLoadConfig() {
        ...
        assertEquals("service is MDS", configurationService.getProperty("newB"));
    ...
    /**
     * Test method for {@link com.mds.servicemanager.config.MDSConfigurationService#clear()}.
     */
    @Test
    ...
    /**
     * Test method for {@link com.mds.servicemanager.config.MDSConfigurationService#reloadConfig()}.
     */
    @Test
    ...
    public void testAutomaticReload() throws ConfigurationException, IOException, InterruptedException {
        ...
        config.addProperty("prop.to.auto.reload", "MDS");
        ...
        assertEquals("MDS", dscs.getProperty("prop.to.auto.reload"));
    ...
    public void testGetPropertiesFromSystem() {
        ...
        System.setProperty("mds.system.config", "Hello");
        System.setProperty("another.property", "Adios");

        dscs.reloadConfig();

        assertEquals(size + 2, dscs.getProperties().size());
        assertEquals("Hello", dscs.getProperty("mds.system.config"));
        assertEquals("Adios", dscs.getProperty("another.property"));

        System.clearProperty("mds.system.config");
    ...
    /**
     * Test method for
     * {@link com.mds.servicemanager.config.MDSConfigurationService#getMDSHome(java.lang.String)}.
     */
    @Test
    public void testGetMDSHomeSysProperty() {
        // Capture current value of MDS_HOME (so we can reset it after test)
        String previousValue = System.getProperty(MDSConfigurationService.MDS_HOME);
        // Change to a mocked value
        System.setProperty(MDSConfigurationService.MDS_HOME, "/mymds");

        // Create a spy of our loaded configurationService, and tell it to return true
        // when "isValidMDSHome()" is called with "/mymds"
        MDSConfigurationService spy = spy(configurationService);
        when(spy.isValidMDSHome("/mymds")).thenReturn(true);

        // Assert Home is the same as System Property
        assertEquals("System property set", "/mymds", spy.getMDSHome(null));

        // reset MDS_HOME to previous value
        System.setProperty(MDSConfigurationService.MDS_HOME, previousValue);
    }

    @Test
    public void testGetMDSHomeSysPropertyOverride() {
        // Capture current value of MDS_HOME (so we can reset it after test)
        String previousValue = System.getProperty(MDSConfigurationService.MDS_HOME);
        // Change to a mocked value
        System.setProperty(MDSConfigurationService.MDS_HOME, "/mymds");
        ...
        assertEquals("System property override", "/mymds", spy.getMDSHome("/myothermds"));
    ...
    @Test
    public void testGetMDSHomeNoSysProperty() {
        // Capture current value of MDS_HOME (so we can reset it after test)
        String previousValue = System.getProperty(MDSConfigurationService.MDS_HOME);
        // Clear the value
        System.clearProperty(MDSConfigurationService.MDS_HOME);
        ...
        assertEquals("Home based on passed in value", "/mymds", spy.getMDSHome("/mymds"));
