...
public class SampleServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        try {
            ...
            if (kernel == null) {
                throw new IllegalStateException("Could not get the MDS Kernel");
            }
            if (!kernel.isRunning()) {
                throw new IllegalStateException("MDS Kernel is not running, cannot startup the DirectServlet");
            }
            ...
            if (requestService == null) {
                throw new IllegalStateException("Could not get the MDS RequestService");
            }
    ...
    protected void service(HttpServletRequest req, HttpServletResponse res)
        ...
        writer.print("MDSTest: request=" + requestService.getCurrentRequestId());
        writer.print(XHTML_FOOTER);
        res.setStatus(HttpServletResponse.SC_OK);

        log.info("Serviced request:  MDS");
    }
