...
import com.mds.kernel.Activator;
...
import com.mds.kernel.mixins.ServiceManagerReadyAware;
import com.mds.kernel.mixins.ShutdownService;
import com.mds.servicemanager.config.MDSConfigurationService;
import com.mds.servicemanager.spring.MDSBeanFactoryPostProcessor;
import com.mds.servicemanager.spring.SpringServiceManager;
 ...
 */
public final class MDSServiceManager implements ServiceManagerSystem {

    private static Logger log = LoggerFactory.getLogger(MDSServiceManager.class);

    public static final String CONFIG_PATH = "spring/spring-mds-applicationContext.xml";
    public static final String CORE_RESOURCE_PATH = "classpath*:spring/spring-mds-core-services.xml";
    public static final String ADDON_RESOURCE_PATH = "classpath*:spring/spring-mds-addon-*-services.xml";

    private final MDSConfigurationService configurationService;
     ...
     */
    public MDSServiceManager(MDSConfigurationService configurationService) {
     ...
     */
    protected MDSServiceManager(MDSConfigurationService configurationService,
    ...
    public void shutdown() {
        ...
        log.info("MDS service manager is shut down.");
    }
    ...
    public void startup() {
        ...
        try {
            ...
            applicationContext.addBeanFactoryPostProcessor(
                    new MDSBeanFactoryPostProcessor(this, configurationService, testing));
            ...
            String message = "Failed to startup the MDS Service Manager: " + e.getMessage();
            log.error(message, e);
        ...
        if (applicationContext.containsBean(name)) {
            try {
                ...
                try {
                    ...
                    MDSServiceManager.shutdownService(beanInstance);
                }
            } catch (BeansException e) {
    ...
    /**
     * Configures a given service (i.e. bean) based on any MDS configuration
     ...
     * @param configurationService MDS configuration source.
     * @return
     */
    public static String[] getSpringPaths(boolean testMode, String[] configPaths,
        ...
        if (testMode) {
            log.warn("TEST Spring Service Manager running in test mode, no MDS home Spring files will be loaded");
        } else {
