 ...
 * E.g.: mds__P__baseUrl will be read as mds.server.url.
 * E.g.: my__D__mds__P__prop will be read as my-mds.prop.
 *
 ...
 */
public class MDSEnvironmentConfiguration extends MapConfiguration {

    private static Logger log = LoggerFactory.getLogger(MDSEnvironmentConfiguration.class);
     ...
     * @see System#getenv()
     */
    public MDSEnvironmentConfiguration() {
