...
/**
 * The central MDS configuration service. Uses Apache Commons Configuration
 ...
 * @author Mark Diggory
 */
public final class MDSConfigurationService implements ConfigurationService {

    private static final Logger log = LoggerFactory.getLogger(MDSConfigurationService.class);

    public static final String MDS = "mdsplus";
    ...
    public static final String MDS_CONFIG_PATH = DEFAULT_CONFIG_DIR + File.separatorChar + MDS + DOT_CONFIG;

    // The MDS Server ID configuration
    public static final String MDS_SERVER_ID = "serverId";
 ...
 // Configuration list delimiter. Configurations with this character will be split into arrays
     ...
     */
    public MDSConfigurationService(String providedHome) {
     ...
     *
     * @see com.mds.services.ConfigurationService#getProperties()
     */
    @Override
     ...
     *
     * @see com.mds.services.ConfigurationService#getPropertyKeys()
     */
    @Override
     ...
     *
     * @see com.mds.services.ConfigurationService#getPropertyKeys(java.lang.String)
     */
    @Override
     ...
     *
     * @see com.mds.services.ConfigurationService#getConfiguration()
     */
    @Override
     ...
     *
     * @see com.mds.services.ConfigurationService#getPropertyValue(java.lang.String)
     */
    @Override
     ...
     * If property is not found, null is returned.
     *
     * @see com.mds.services.ConfigurationService#getProperty(java.lang.String)
     */
    @Override
     ...
     *
     * @see com.mds.services.ConfigurationService#getProperty(java.lang.String, java.lang.String)
     */
    @Override
     ...
     *
     * @see com.mds.services.ConfigurationService#getArrayProperty(java.lang.String)
     */
    @Override
     ...
     * If property is not found, default value is returned.
     *
     * @see com.mds.services.ConfigurationService#getArrayProperty(java.lang.String, java.lang.String[])
     */
    @Override
     ...
     *
     * @see com.mds.services.ConfigurationService#getBooleanProperty(java.lang.String)
     */
    @Override
     ...
     * If property is not found, default value is returned.
     *
     * @see com.mds.services.ConfigurationService#getBooleanProperty(java.lang.String, boolean)
     */
    @Override
     ...
     *
     * @see com.mds.services.ConfigurationService#getIntProperty(java.lang.String)
     */
    @Override
     ...
     * If property is not found, default value is returned.
     *
     * @see com.mds.services.ConfigurationService#getIntProperty(java.lang.String, int)
     */
    @Override
     ...
     *
     * @see com.mds.services.ConfigurationService#getLongProperty(java.lang.String)
     */
    @Override
     ...
     * If property is not found, default value is returned.
     *
     * @see com.mds.services.ConfigurationService#getLongProperty(java.lang.String, long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.mds.services.ConfigurationService#getPropertyAsType(java.lang.String, java.lang.Class)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.mds.services.ConfigurationService#getPropertyAsType(java.lang.String, java.lang.Object)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.mds.services.ConfigurationService#getPropertyAsType(java.lang.String, java.lang.Object, boolean)
     */
    @Override
     ...
     *
     * @see com.mds.services.ConfigurationService#hasProperty(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.mds.services.ConfigurationService#setProperty(java.lang.String, java.lang.Object)
     */
    @Override
    ...
    /**
     * Loads up the configuration from the MDS configuration files.
     * <P>
     * Determines the home directory of MDS, and then loads the configurations
     * based on the configuration definition file in that location
     * (using Apache Commons Configuration).
     *
     * @param providedHome MDS home directory, or null.
     */
    private void loadInitialConfig(String providedHome) {
        // Determine the MDS home directory
        homePath = getMDSHome(providedHome);

        // Based on homePath get full path to the configuration definition
        this.configDefinition = homePath + File.separatorChar + MDS_CONFIG_DEFINITION_PATH;
        ...
        if (!configDefFile.exists()) {
            try {
                ...
                ClassPathResource resource = new ClassPathResource(MDS_CONFIG_DEFINITION_PATH);
    ...
    /**
     * Reload the configuration from the MDS configuration files.
     * <P>
    ...
    private void setDynamicProperties() {
        // Ensure our MDS_HOME property is set to the determined homePath
        setProperty(MDS_HOME, this.homePath);
        ...
        try {
            ...
            setProperty(MDS_SERVER_ID, defaultServerId);
    ...
    public String toString() {
        ...
        return "ConfigDir=" + getConfiguration()
            .getString(MDS_HOME) + File.separatorChar + DEFAULT_CONFIG_DIR + ", Size=" + size;
    }

    /**
     * This attempts to find the MDS home directory, based on system properties,
     * and the providedHome (if not null).
     * <p>The initial value of {@code mdsplus.home} will be:</p>
     * <ol>
     * <li>the value of the system property {@code mdsplus.home} if defined;</li>
     * <li>else the value of {@code providedHome} if not null;</li>
     * <li>else the servlet container's home + "/mds/" if defined (see
     * {@link MDSConfigurationService#getCatalina()});</li>
     * <li>else the user's home directory if defined;</li>
     * <li>else "/".</li>
     * </ol>
     *
     * @param providedHome provided home directory (may be null)
     * @return full path to MDS home
     */
    protected String getMDSHome(String providedHome) {
        ...
        throw new RuntimeException("MDS home directory could not be determined. It MUST include a subpath of " +
                                       "'" + File.separatorChar + MDS_CONFIG_DEFINITION_PATH + "'. " +
     ...
     */
    protected boolean isValidMDSHome(String path) {
