 ...
 * automatically check the typical places one might expect to put MDS
 * config files.
 *
...
public class ResourceFinder {
    ...
    public static final String relativePath = MDSConfigurationService.MDS + "/";
    public static final String environmentPathVariable = MDSConfigurationService.MDS_HOME;
     ...
     *
     * @param path a path to a resource (org/mds/mystuff/Thing.xml)
     ...
     *
     * @param paths an array of paths to a resource (org/mds/mystuff/Thing.xml)
     * @return the Spring Resource object
     * @throws IllegalArgumentException if no resource can be found
     */
    ...
    protected static String getRelativePath() {
        ...
        if (!f.exists() || !f.isDirectory()) {
            f = new File(currentPath, MDSConfigurationService.MDS);
            if (!f.exists() || !f.isDirectory()) {
                f = currentPath;
            }
        }
    ...
    protected static String getEnvironmentPath() {
        ...
        if (envPath == null) {
            ...
            if (envPath == null) {
                ...
                envPath = container + File.separatorChar + MDSConfigurationService.MDS + File.separatorChar;
            }
        }
        return envPath;
    }
