...
public final class SpringServiceManager implements ServiceManagerSystem {
     ...
     */
    public SpringServiceManager(ServiceManagerSystem parent, MDSConfigurationService configurationService,
    ...
    public static final String configPath = "spring/spring-mds-applicationContext.xml";
    public static final String coreResourcePath = "classpath*:spring/spring-mds-core-services.xml";
    public static final String addonResourcePath = "classpath*:spring/spring-mds-addon-*-services.xml";
    ...
    public void startup() {
        ...
        applicationContext
            .addBeanFactoryPostProcessor(new MDSBeanFactoryPostProcessor(parent, configurationService, testMode));
