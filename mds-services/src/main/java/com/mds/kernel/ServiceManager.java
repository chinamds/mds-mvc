...
public interface ServiceManager {
     ...
     * inherit the core service beans from the MDS core service
     ...
     * @throws IllegalArgumentException if the service cannot be registered because the name is taken or type is
     * invalid or other
