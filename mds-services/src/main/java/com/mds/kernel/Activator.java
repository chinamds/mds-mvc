 ...
 * the MDS configuration with the fully qualified classpath
 * (NOTE that the xxx can be anything as long as it is unique): <br>
 * {@code activator.xxx = com.mds.MyClass}
 * </p>
 * <p>
 ...
 * <p>
 * There is another type of activator used in MDS but it is
 * configured via the configuration service only.  The class activator
 * is configured by creating a config property like this
 * (NOTE that the xxx can be anything as long as it is unique): <br>
 * {@code activator.class.xxx = com.mds.MyClass;com.mds.MyServiceName;constructor}<br>
