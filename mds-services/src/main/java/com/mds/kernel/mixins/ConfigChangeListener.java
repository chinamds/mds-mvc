 ...
 * requiring a restart.
 * <p>
 * This is a MDS mixin, which means it will be triggered because this
 * is a MDS service or provider.  The system will pick up on the fact
...
public interface ConfigChangeListener {
     ...
     * (e.g. {@code downloadEnabled@com.mds.ThisService}).
     ...
     * settings.
     * Example: downloadEnabled@com.mds.ThisService =&gt; downloadEnabled
     *
