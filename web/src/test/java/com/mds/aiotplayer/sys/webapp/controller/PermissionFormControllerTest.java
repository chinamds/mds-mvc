...
@Transactional
public class PermissionFormControllerTest extends BaseControllerTestCase {
    @Autowired
    private PermissionFormController controller;
    ...
    public void testEdit() throws Exception {
        ...
        mockMvc.perform(get("/sys/permissionform")
            .param("id", "-1"))
    ...
    public void testSave() throws Exception {
        HttpSession session = mockMvc.perform(post("/sys/permissionform")
