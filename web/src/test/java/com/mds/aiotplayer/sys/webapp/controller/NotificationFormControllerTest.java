...
@Transactional
public class NotificationFormControllerTest extends BaseControllerTestCase {
    @Autowired
    private NotificationFormController controller;
    ...
    public void testEdit() throws Exception {
        ...
        mockMvc.perform(get("/notificationform")
            .param("id", "-1"))
    ...
    public void testSave() throws Exception {
        HttpSession session = mockMvc.perform(post("/notificationform")
        		.param("user_id", "-1")
            )
