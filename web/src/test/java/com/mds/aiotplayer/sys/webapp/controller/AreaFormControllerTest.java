...
@Transactional
public class AreaFormControllerTest extends BaseControllerTestCase {
    @Autowired
    private AreaFormController controller;
    ...
    public void testEdit() throws Exception {
        ...
        mockMvc.perform(get("/sys/areaform")
            .param("id", "-1"))
    ...
    public void testSave() throws Exception {
        HttpSession session = mockMvc.perform(post("/sys/areaform")
        		.param("code", "test")
            )
