...
@Transactional
public class CalendarFormControllerTest extends BaseControllerTestCase {
    @Autowired
    ...
    public void testEdit() throws Exception {
        ...
        mockMvc.perform(get("/sch/calendarform")
            .param("id", "-1"))
    ...
    public void testSave() throws Exception {
        HttpSession session = mockMvc.perform(post("/sch/calendarform")
        	.param("channelId", "-1")
            .param("approvalLevel", "116")
            .param("approvalStatus", "5")
            .param("day", "11/23/2016")
            .param("playMeth", "20")
            )
