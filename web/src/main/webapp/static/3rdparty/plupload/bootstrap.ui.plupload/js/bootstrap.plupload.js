;(function (factory) {
  ...
  'use strict';
    ...
    function renderUI(obj) {		
        ...
        obj.html(
            '<div class="card plupload_wrapper">' +
                '<div class="card-body plupload_container p-0">' +
	...
	*/
    ...
    BSpupload.prototype._viewChanged = function(view) {
		...
		if (o.Env.browser === 'IE' && o.Env.browser < 7) {
  ...
  function Plugin(option) {
	  if (typeof option === 'object') {
		...
		this.each(function () {
          ...
          if (data == null && window.console && console.error) {
            console.error(
              'The bsupload(\'' + options + '\') method was called on an ' +
              'element that is not using BSpupload.'
            );
          }

          ret = data[option].apply(data, null);
        });
