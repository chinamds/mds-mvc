...
;(function ($, window) {
  ...
  var tabElements = (function () {
    ...
    function getNewElTabAnchor(tab, propNames, options) {
      return options.tabLiAContent ? $(options.tabLiAContent) : $('<a role="tab" data-toggle="tab"></a>')
    ...
    function getNewElTabLi(tab, propNames, options) {
      var liContent = options.tabLiContent || '<li role="presentation" class=""></li>',
          $li = $(liContent),
          $a = getNewElTabAnchor(tab, propNames, options).appendTo($li);
      $a = $li.find('a[role="tab"]');
  ...
  function buildNavTabsAndTabContentForTargetElementInstance($targetElInstance, settings, readyCallback) {
    ...
    tabs.forEach(function(tab, index) {
      var options = {
        ...
        tabLiAContent: settings.tabsLiAContent && settings.tabsLiAContent[index],
    ...
    $targetElInstance.data({
      scrtabs: {
        ...
        tabsLiAContent: settings.tabsLiAContent,
  ...
  function checkForTabAdded(refreshData) {
    var updatedTabsArray = refreshData.updatedTabsArray,
        ...
        updatedTabsLiAContent = refreshData.updatedTabsLiAContent || [],
    ...
    updatedTabsArray.forEach(function (tab, idx) {
      ...
      if (!$li.length) { // new tab
        ...
        options.tabLiAContent = updatedTabsLiAContent[idx];
  ...
  function refreshDataDrivenTabs($container, options) {
    var instanceData = $container.data().scrtabs,
        ...
        refreshData = {
          ...
          updatedTabsLiAContent: instanceData.tabsLiAContent,
