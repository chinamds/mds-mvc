...
<head>
    <title><fmt:message key="contentListList.title"/></title>
    <meta name="menu" content="ContentListMenu"/>
</head>

<c:set var="group" value="grp_form" scope="request" />
<c:set var="scripts" scope="request">
<%@ include file="/static/scripts/cm/contentList.js"%>
</c:set>
...
<h2><fmt:message key="contentListList.heading"/></h2>

<%-- <form method="get" action="${ctx}/contentLists" id="searchForm" class="form-inline">
...
<div id="importBox" class="hidden d-none">
	<form id="importForm" action="${ctx}/cm/contentLists/import" method="post" enctype="multipart/form-data"
		...
		<a href="${ctx}/cm/contentLists/import/template"><fmt:message key="button.downloadtemplate"/></a>
	</form>
</div>

<div id="actions" class="btn-group">
	<secure:hasPermission name="cm:contentLists:add">
    <a href='<c:url value="/cm/contentListform?method=Add"/>' class="btn btn-primary">
    ...
    <button id="btnImport" class="btn btn-success hidden-xs" type="button" title="<fmt:message key="button.import"/>">
     ...
     <secure:hasPermission name="cm:contentLists:data_export">
...
<div class="table-responsive">
	<table id="table">
       ...
       <tr>
           ...
           <%-- <th data-field="content" data-formatter="nameFormatter"><fmt:message key="contentList.name"/></th> --%>
            <th data-field="thumbnailHtml" data-formatter="thumbnailFormatter"><fmt:message key="contentList.contentName"/></th>
	        <th data-field="desc"><fmt:message key="contentList.desc"/></th>             
	        <th data-field="createdBy"><fmt:message key="contentList.createdBy"/></th>
	        <th data-field="dateAdded" data-formatter="dateTimeFormatter"><fmt:message key="contentList.dateAdded"/></th>
        </tr>
        </thead>
    </table>
</div>
