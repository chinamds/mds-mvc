...
<div class="col-sm-7">
    ...
    <form:form modelAttribute="user" method="post" action="${ctx}/sys/signup" id="signupForm" autocomplete="off"
        ...
        <div class="form-group">
            ...
            <button type="submit" class="btn btn-primary" name="save" onclick="bCancel=false">
                <i class="fa fa-check icon-white"></i> <fmt:message key="button.register"/>
            </button>
...
<%@ include file="/static/scripts/sys/signup.js"%>
