...
<%@ include file="/static/scripts/wf/activity.js"%>
</c:set>
...
<%-- <form method="get" action="${ctx}/activities" id="searchForm" class="form-inline">
...
<p><fmt:message key="activityList.message"/></p>

<div id="importBox" class="hidden d-none">
	<form id="importForm" action="${ctx}/wf/activities/import" method="post" enctype="multipart/form-data"
		...
		<a href="${ctx}/wf/activities/import/template"><fmt:message key="button.downloadtemplate"/></a>
	</form>
</div>

<div id="actions" class="btn-group">
	<secure:hasPermission name="wf:activities:add">
    <a href='<c:url value="/wf/activityform"/>' class="btn btn-primary">
    ...
    <secure:hasPermission name="wf:activities:data_import">
    <button id="btnImport" class="btn btn-success hidden-xs" type="button" title="<fmt:message key="button.import"/>">
     ...
     <secure:hasPermission name="wf:activities:data_export">
    ...
    <secure:hasAnyPermissions name="wf:activities:data_import,wf:activities:data_export">
...
<div class="table-responsive">
	<table id="table">
       ...
       <tr>
            ...
            <%-- <th data-field="content" data-formatter="nameFormatter"><fmt:message key="activity.name"/></th> --%>
           	<th data-field="code" data-formatter="nameFormatter"><fmt:message key="activity.code"/></th>
	        <th data-field="organizationCode"><fmt:message key="activity.organization"/></th>       
	        <th data-field="description"><fmt:message key="activity.description"/></th>        
	        <th data-field="createdBy"><fmt:message key="activity.createdBy"/></th>
	        <th data-field="dateAdded" data-formatter="dateTimeFormatter"><fmt:message key="activity.dateAdded"/></th>
	        </tr>
        </thead>
    </table>
</div>
