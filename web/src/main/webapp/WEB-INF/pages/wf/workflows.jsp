...
<h2><fmt:message key="workflowList.heading"/></h2>

<%-- <form method="get" action="${ctx}/workflows" id="searchForm" class="form-inline">
...
<p><fmt:message key="workflowList.message"/></p>

<div id="importBox" class="hidden d-none">
	<form id="importForm" action="${ctx}/wf/workflows/import" method="post" enctype="multipart/form-data"
		...
		<a href="${ctx}/wf/workflows/import/template"><fmt:message key="button.downloadtemplate"/></a>
	</form>
</div>

<div id="actions" class="btn-group">
	<secure:hasPermission name="wf:workflows:add">
    <a href='<c:url value="/wf/workflowform?method=Add"/>' class="btn btn-primary">
    ...
    <secure:hasPermission name="wf:workflows:data_import">
    <button id="btnImport" class="btn btn-success hidden-xs" type="button" title="<fmt:message key="button.import"/>">
     ...
     <secure:hasPermission name="wf:workflows:data_export">
    ...
    <secure:hasAnyPermissions name="wf:workflows:data_import,wf:workflows:data_export">
...
<div class="table-responsive">
	<table id="table">
       ...
       <tr>
           ...
           <%-- <th data-field="content" data-formatter="nameFormatter"><fmt:message key="workflow.name"/></th> --%>
           	<th data-field="workflowName" data-formatter="nameFormatter"><fmt:message key="workflow.workflowName"/></th>
        	<th data-field="workflowType"><fmt:message key="workflow.workflowType"/></th>       
        	<th data-field="flowchart" data-formatter="flowchartFormatter"><fmt:message key="workflow.flowchart"/></th>        
        	<th data-field="createdBy"><fmt:message key="workflow.createdBy"/></th>
        	<th data-field="dateAdded" data-formatter="dateTimeFormatter"><fmt:message key="workflow.dateAdded"/></th>
        </tr>
        </thead>
    </table>
</div>
