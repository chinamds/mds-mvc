 ...
 */
package com.mds.aiotplayer.webapp.common.taglib;
...
public class LabelTag extends TagSupport {
    ...
    protected transient final Logger log = LoggerFactory.getLogger(LabelTag.class);
    ...
    public int doStartTag() throws JspException {
        ...
        String message = null;
        try {
            message = I18nUtils.getString(key, locale); //getMessageSource().getMessage(key, null, locale);
