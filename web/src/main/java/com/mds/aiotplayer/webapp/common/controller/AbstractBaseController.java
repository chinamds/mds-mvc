 ...
 * <p>Version: 1.0
 */
public abstract class AbstractBaseController<M extends AbstractEntity, ID extends Serializable> {
    ...
    protected String defaultViewPrefix() {
        ...
        if (requestMapping != null && requestMapping.value().length > 0) {
            ...
            currentViewPrefix = StringUtils.trimTrailingCharacter(currentViewPrefix, '*');
        }
